...
<?php
    ...
    $clientListQuery="SELECT * FROM clients";
    $clientList=mysqli_query($con, $clientListQuery);
...
<script>
    ...
    $("#cust_name").keyup(function() {
        ...
        <?php 
            $oldBalanceQuery="SELECT * FROM invoice ORDER BY invoice_no DESC LIMIT 1";
            $oldBalanceSelection=mysqli_query($con, $oldBalanceQuery);
        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="card" style="box-shadow:0 0 25px lightgrey;">
                    ...
                    <div class="card-body">
                        <form id="get_quote_data" onsubmit="return false">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" align="right">Quote Date</label>
                                <div class="col-sm-6">
                                    <input type="text" id="quote_date" name="quote_date" readonly class="form-control form-control-sm" value="<?php echo date("Y-m-d"); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <center>
                                <input type="submit" id="quote_form" style="width:150px;" class="btn btn-info" value="Quote">
                                <input type="submit" id="print_quote" style="width:150px;" class="btn btn-success d-none" value="Print Quote">
                            </center>
